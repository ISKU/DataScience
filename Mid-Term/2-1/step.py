...
step_list = [[0 for x in range(51)] for y in range(99)]
step_list[0][0] = 'date'

for i in range(1, 99, 1) :
    step_list[i][0] = 'A0' + str(i)
...
for i in range(1, 99, 1) :
    ...
    for date in date_list :
        ...
        print(filePath)
        step_list[i][j] = json_step['activities-steps'][0]['value'] if ('activities-steps' in json_step) else 0
        j += 1


write_file = open('avgsteps.csv', 'w')
